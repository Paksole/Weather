...
public class Main {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        if (response2.statusCode() == 200) {
            ...
            System.out.println("Âåñü îòâåò îò ñåðâèñà â ôîðìàòå JSON:");
            ...
            System.out.println("Òåêóùàÿ òåìïåðàòóðà: " + temperature + "°C");
        } else {
            System.err.println("Ïðîèçîøëà îøèáêà ïðè âûïîëíåíèè çàïðîñà. Êîä îøèáêè: " + response2.statusCode());
        }
        ...
        for (int i = 0; i < limit; i++) {
            ...
            if (responseWeek.statusCode() == 200) {
               ...
               System.err.println("Ïðîèçîøëà îøèáêà ïðè âûïîëíåíèè çàïðîñà. Êîä îøèáêè: " + responseWeek.statusCode());
            }
        }
    ...
    double averageTemperature = sumTemperatures / temperatures.length;
        ...
        System.out.printf("Ñðåäíÿÿ òåìïåðàòóðà çà %d äíåé: %.2f°C\n", limit, averageTemperature);
